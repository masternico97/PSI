...
if os.getenv('SQLITE', False):
    ...
    # define an enviroment variable called DATABASEURL
    # and use it to initializate DATABASES
    # dictionary
    # export DATABASEURL = 'postgres://alumnodb:
    # alumnodb@localhost:5432/ratongato'
